...
- (IMChat*)existingChatForRoom:(id)arg1 onAccount:(id)arg2 allowRetargeting:(BOOL)arg3;
...
- (IMChat*)existingChatForIMHandles:(id)arg1 allowRetargeting:(BOOL)arg2 groupID:(id)arg3 displayName:(id)arg4 ignoresDisplayName:(BOOL)arg5 joinedChatsOnly:(BOOL)arg6;
- (IMChat*)existingChatForAddresses:(id)arg1 allowRetargeting:(BOOL)arg2 bestHandles:(id *)arg3;
...
- (IMChat*)exisitingChatForGroupID:(id)arg1;
- (IMChat*)existingChatForRoom:(id)arg1 onAccount:(id)arg2;
- (IMChat*)existingChatForIMHandles:(id)arg1;
...
- (IMChat*)_lookupExistingChatWithIMHandle:(id)arg1;
