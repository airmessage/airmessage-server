...
protocol DataProxy {
	associatedtype C: ClientConnection
	 ...
	 */
	func send(message data: Data, to client: C, encrypt: Bool, onSent: (() -> Void)?)
	 ...
	 */
	mutating func disconnect(client: C)
}